...
sudo pacman -Sy
sudo pacman -Sy --noconfirm flatpak fastfetch firefox less git docker minikube kubectl ntfs-3g tmux stow tree unzip okular obsidian xclip zsh qbittorrent neovim fzf flameshot vagrant virtualbox
